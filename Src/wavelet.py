...
#img_path = "../samples1/good/"#args.img_path

#result_path = '../samples1/wavelet_good/'

#test_file = '../samples1/good.txt'

img_path = "./BUS/origin/"#args.img_path

result_path = './BUS/wavelet/'

test_file = './BUS/BUS_ALL.txt'
